        ...
        >
            <li class="inline-flex items-center">
                <a
                    href="{{ route('home') }}"
                    wire:navigate
                    class="inline-flex items-center sm:text-base text-sm font-semibold text-[#0D1B2A] hover:text-[#FF4D30]"
                >
            ...
            <li>
                <div class="flex items-center">
                    <svg class="h-5 w-5 text-[#0D1B2A] rtl:rotate-180" aria-hidden="true"
                    ...
                    <a
                        ...
                        wire:navigate
                        class="ms-1 sm:text-base text-sm font-semibold text-[#0D1B2A] hover:text-[#FF4D30]"
                    >
                        Shop by Brand
                    </a>
                </div>
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span
                        class="ms-1 sm:text-base text-sm font-semibold text-[#FF4D30]  md:ms-2"
                    >
                        {{ $brand->name }}
                    </span>
                </div>
