        ...
        <div class="p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex items-center space-x-4">
                    <a
                        href="{{ route('admin.create-category') }}"
                        wire:navigate
                    ...
                    >
                        ...
                        <span class="font-semibold sm:text-base text-sm">Create Category</span>
                    </a>
                </div>
            </div>
                ...
                <table class="w-full">
                    ...
                    @forelse($categories as $category)
                        ...
                        >
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex-shrink-0 h-10 w-10">
                                    <div class="h-10 w-10 rounded">
                                        <img src=" {{ asset('storage/categories_icons/' . $category->logo) }}">
                                    </div>
                                </div>
                            </td>
                            ...
                            >
                                <a
                                    href="{{ route('admin.edit-category', $category) }}"
                                    wire:navigate
                    ...
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        <div class="relative bg-white rounded-lg shadow-sm">
                            ...
                            <div class="p-4 md:p-5 text-center">
                                ...
                                <h3 class="mb-5 text-lg font-semibold text-[#0D1B2A]">Are you sure you want to delete this category?</h3>
                                <button
                                    type="button"
                                    @click="$wire.deleteCategory(selected); selected = null"
