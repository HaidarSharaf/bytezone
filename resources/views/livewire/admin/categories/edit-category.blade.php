            ...
            <form wire:submit="save">
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div class="col-span-2">
                        <label class="block mb-2 text-sm font-semibold text-[#0D1B2A]">
                            Name
                            <span wire:dirty wire:target="form.name" class="text-red-600">*</span>
                        </label>
                        <input
                            type="text"
                    ...
                    <div class="mt-4 mb-2 sm:col-span-2">
                        ...
                        @elseif($form->logo_path)
                            <div class="flex items-center justify-center mt-4">
                                <img src="{{ asset('storage/categories_icons/' . $form->logo_path) }}" class="w-36 h-36 object-cover">
                            </div>
                        @endif
                ...
                <div class="flex justify-end">
                    <button
                        ...
                        wire:target="save"
                        class="cursor-pointer text-white bg-[#FF4D30] hover:bg-[#F53003] focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                    >
                        <div
