            ...
            <div class="flex items-center justify-between mb-6">
                ...
                @if(auth()->user()->admin->role_id === 1)
                    ...
                    >
                        ...
                        <span class="font-semibold sm:text-base text-sm">Create Admin</span>
                    </a>
                ...
                >
                    ...
                    >
                        @foreach($users as $user)
                           ...
                           @if(auth()->user()->admin->role_id === 1 && $user->admin->role_id !== 1)
                                <td
                                    class="px-6 py-4 text-sm text-[#0D1B2A] font-semibold"
                                >
                                    <button
                                        @click="selected = {{ $user->id }}"
                                        class="px-4 py-2 text-white rounded-lg cursor-pointer bg-red-600 hover:bg-red-700"
                                    >
                                        Demote
                                    </button>
                                </td>
                    ...
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        <div class="relative bg-white rounded-lg shadow-sm">
                            ...
                            <div class="p-4 md:p-5 text-center">
                                ...
                                <button
                                    type="button"
                                    @click=" $wire.demoteAdmin(selected); selected = null;"
                                    class="text-white bg-red-600 hover:bg-red-700 focus:ring-red-300 focus:ring-4 cursor-pointer focus:outline-none font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center"
                                >
                                    Yes, I'm sure
                                </button>
