<div class="rounded-2xl bg-white shadow-xl sm:w-[600px] w-[310px] mx-auto mt-5">

    <form wire:submit.prevent="create" class="lg:p-11 p-7 mx-auto">

        <div class="mb-11">
            <h1 class="text-[#0D1B2A] text-center font-manrope text-3xl font-bold leading-10 mb-2">
        ...
        <div class="space-y-6">
            ...
            <div>
                <label class='text-sm text-[#0D1B2A] font-medium mb-2 block'>Phone Number:</label>
                <div class="flex items-center">
                    <p class="inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-gray-100 border-1 border-[#0D1B2A] rounded-md">
                        <svg viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                             class="iconify iconify--twemoji w-4 h-4 mr-2" preserveAspectRatio="xMidYMid meet" fill="#000000">
                    ...
                    <input
                        ...
                        inputmode="numeric"
                        maxlength="8"
                        pattern="(03|70|71|76|78|79|81)\d{6}"
                        class="bg-gray-100 w-full text-sm text-[#0D1B2A] px-4 py-2.5 outline-0 border-1 border-[#0D1B2A] focus-within:ring-2 rounded-md focus-within:ring-[#0D1B2A] focus:outline-none"
                    />
                </div>
                @error('phone_number')
                <span class="text-[#FF4D30] text-sm">{{ $message }}</span>
            ...
            <div>
                <label class='text-sm text-[#0D1B2A] font-medium mb-2 block'>Secret Code:</label>
                <input
                    wire:model="secret"
                    type="password"
                    class="bg-gray-100 w-full text-sm text-[#0D1B2A] px-4 py-3 rounded-md outline-0 border-1 border-[#0D1B2A] focus-within:ring-2 focus-within:ring-[#0D1B2A] focus:outline-none"
        ...
        <div class="!mt-12">
            <button
                ...
                wire:target="create"
                class="w-full flex justify-center items-center shadow-xl py-2.5 px-4 text-[15px] font-medium rounded-md text-white bg-[#FF4D30] hover:bg-[#F53003] focus:outline-none cursor-pointer disabled:cursor-not-allowed"
            >
                <div
                    class="font-semibold"
                    wire:loading.remove
